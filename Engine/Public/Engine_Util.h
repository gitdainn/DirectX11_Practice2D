...
namespace Engine
{
	...
	{
	public:
		static _bool	Convert_CCW(_float3* _vPointA, _float3* _vPointB, _float3* _vPointC);
		static _int		Get_CCW(_float3 _vPointA, _float3 _vPointB, _float3 _vPointC);

		static _matrix	Remove_Rotation(_fmatrix _Matrix);
		static _matrix	Remove_Scale(_fmatrix _Matrix);
		static _matrix	Remove_Position(_fmatrix _Matrix);
		...
		static _bool	Get_VectorIsNan(_fvector vVector);
		/* �� ���� ��(x,y,z,w)�� ������ true �� ��ȯ �մϴ�. */
		static _bool	Get_VectorIsEquel(_fvector vVector1, _fvector vVector2);
		/* ��ġ + ȸ�� �� �� �ִ� �ΰ��� ��Ʈ������ ���� �մϴ�. */
		static _matrix	Get_MatrixLerp(_fmatrix Matrix1, _cmatrix Matrix2, _float t);
		...
		*/
		...
		static _float3 Get_ExtractRotationFromMatrix(_matrix matrix);
