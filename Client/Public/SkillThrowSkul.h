...
class CSkillThrowSkul final : public CSkill
{
public:
	explicit CSkillThrowSkul(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	~CSkillThrowSkul() {}
...
public:
	/* Prototype */
	static CSkillThrowSkul* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
