...
class CSkillHighTide final : public CSkill
{
public:
	explicit CSkillHighTide(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
	~CSkillHighTide() {}
...
public:
	/* Prototype */
	static CSkillHighTide* Create(ID3D11Device* pDevice, ID3D11DeviceContext* pContext);
